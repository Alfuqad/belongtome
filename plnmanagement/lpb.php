            ...
            <div class="dropdown mb-3">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        ...
                        <input type="file" id="fileUploadInput" class="d-none" multiple onchange="uploadFile()" />
                    </li>
            ...
            <script>
                ...
                function uploadFile() {
                    ...
                    for (let i = 0; i < fileInput.files.length; i++) {
                        formData.append("files[]", fileInput.files[i]); // Menggunakan "files[]" agar sesuai dengan PHP
                    }
                ...
                function uploadFolder() {
                    ...
                    console.log("File yang akan diupload:");
                    for (let file of folderInput.files) {
                        let relativePath = file.webkitRelativePath; // Path relatif dalam folder
                        console.log(`File: ${file.name}, Path: ${relativePath}`);

                        formData.append("files[]", file);
                        formData.append("paths[]", relativePath); // Kirim path agar backend bisa buat struktur folder
                    }
                    ...
                    fetch("http://localhost/plnmanagement/backend/upload.php", {
                        ...
                        .then(response => response.text()) // Ambil sebagai teks dulu untuk debugging
                        .then(text => {
                            try {
